...
export function CustomersPage() {
  ...
  function onSubmit(data: CustomerForm) {
    ...
    reset()
    setIsModalOpen(false)
    toast.success('Firma başarıyla eklendi', { description: `${customer.name} Firma portföyüne eklendi.` })
  }
