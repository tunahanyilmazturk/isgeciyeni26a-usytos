...
export function CustomerCreatePage() {
  ...
  function saveDraft() {
    toast.success('Taslak kaydedildi', { description: 'Müşteri bilgileri bu oturum için saklandı.' })
  }
