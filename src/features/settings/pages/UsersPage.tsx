...
type SystemUser = { id: number; firstName: string; lastName: string; username: string; email: string; phone?: string; role: UserRole; company: string; permissions?: ModuleId[]; lastLogin: string; status: UserStatus }
...
function initials(user: SystemUser) { return `${user.firstName[0]}${user.lastName[0]}`.toLocaleUpperCase('tr-TR') }
