...
export function ParticipantsPage() {
  ...
  function handleUpdateParticipant(updatedParticipant: Participant) {
    setParticipants((current) => current.map((participant) => participant.id === updatedParticipant.id ? updatedParticipant : participant))
